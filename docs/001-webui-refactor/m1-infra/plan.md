...
- [ ] **T1.5** · 其他原子 UI 重写（badge / input / select / textarea / skeleton） → [tasks/T1.5-atomic-ui-rewrite.md](tasks/T1.5-atomic-ui-rewrite.md)
- [ ] **T1.6** · Card 拆分 + 新增组件（tooltip / dialog / separator） → [tasks/T1.6-card-and-new-ui.md](tasks/T1.6-card-and-new-ui.md)
